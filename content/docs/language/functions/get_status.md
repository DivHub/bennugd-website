...
Used in example: [`exit()`]({{< ref "/docs/language/functions/exit" >}}), [`key()`]({{< ref "/docs/language/functions/key" >}}), [`say()`]({{< ref "/docs/language/functions/say" >}}), [`signal()`]({{< ref "/docs/language/functions/signal" >}}).
