...
This example could also be done with [`fget_dist()`]({{< ref "/docs/language/functions/fget_dist" >}}), which is easier and doesn't require an extra process. It also give a much more accurate distance when the resolution is `>1`.
